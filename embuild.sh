...
LDFLAGS="-sINITIAL_MEMORY=33554432 -sEXPORTED_RUNTIME_METHODS=ccall -sEXPORTED_FUNCTIONS=_check_syntax,_init_tcc -sENVIRONMENT=worker -sEXIT_RUNTIME=0 -sSTRICT=1"
